...
@QuarkusTest
@TestProfile(InvalidPathAdditionalResourcesTest.Profile.class)
public class InvalidPathAdditionalResourcesTest {
    ...
    public static class Profile implements QuarkusTestProfile {
        ...
        public Map<String, String> getConfigOverrides() {
            return Map.of("tyr.additional-resources", "src/test/resources/generated/non-existent-custom-resources.jar");
        }
    }
