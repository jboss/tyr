...
@QuarkusTest
@TestProfile(FormatUndefinedTest.Profile.class)
class FormatUndefinedTest {
    @Inject
    ...
    @Test
    public void testConfigUnsetFormatFileUrlAndFilePath() {
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> templateChecker.checkPR(TestUtils.TEST_PAYLOAD),
                "Expected IllegalArgumentException to be thrown when format is not defined");
    }
}
